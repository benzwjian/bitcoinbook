...
do {
  var buf = crypto.randomBytes(32) //32 bytes buffer, 256 bits buffer, or 64 hex digits
...
// generate bitcoin address: 1PRTTaJesdNovgne6Ehcdu1fpEdX7913CK
var address = base58Check(doubleHash(publicKey))
```
...
// generate WIF: 5J3mBbAH58CpQ3Y5RNJpUKPE62SQ5tfcvU2JpbnkeyhfsYB1Jcn
var wif = wif(privateKey)

// generate compressed WIF: KxFC1jmwwCoACiCAWZ3eXa96mBM6tb3TYzGmf6YwgdGWZgawvrtJ
var compressedWIF = wifCompressed(privateKey)
```
...
// have a private key in WIF
var wif = '5J3mBbAH58CpQ3Y5RNJpUKPE62SQ5tfcvU2JpbnkeyhfsYB1Jcn'

// get version, payload, checksum
var wrapper = decodeBase58Check(wif)
```
...
var bPrivateKey = BigInt.fromBuffer(privateKey)

//get EC points
var ecPoints = ecurveSecp256k1.G.multiply(bPrivateKey)

//get uncompressed public key: 04F028892BAD7ED57D2FB57BF33081D5CFCF6F9ED3D3D7F159C2E2FFF579DC341A07CF33DA18BD734C600B96A72BBC4749D5141C90EC8AC328AE52DDFE2E505BDB
var uncompressedPublicKey = ecPoints.getEncoded(false)

//get compressed public key: 03F028892BAD7ED57D2FB57BF33081D5CFCF6F9ED3D3D7F159C2E2FFF579DC341A
var compressedPublicKey = ecPoints.getEncoded(true)
```
